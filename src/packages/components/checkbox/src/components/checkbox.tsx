...
import { chain, getOptionalObject } from "@renderui/utils"
import type React from "react"
import { DEFAULT_CHECKBOX_CLASSNAME } from "../constants/constants"
...
const Checkbox = (props: CheckboxProps) => {
	...
	return (
		<Button
			...
			hasRipple={hasRipple}
			className={[DEFAULT_CHECKBOX_CLASSNAME, className]}
			startContent={
