const DEFAULT_ACCORDION_CLASSNAME = "_accordion"
...
const DEFAULT_ACCORDION_TRIGGER_PRIMITIVE_CLASSNAME = "_accordion-trigger-primitive"
...
export {
  DEFAULT_ACCORDION_CLASSNAME,
  DEFAULT_ACCORDION_CONTENT_CHILDREN_CONTAINER_CLASSNAME,
  DEFAULT_ACCORDION_TRIGGER_PRIMITIVE_CLASSNAME,
