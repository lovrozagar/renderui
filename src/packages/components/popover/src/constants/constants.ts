...
const DEFAULT_POPOVER_CONTENT_ARROW_CONTAINER_CLASSNAME =
	"_popover-content-arrow-container relative before:absolute before:size-[8px] before:rotate-45 before:top-[-4px] before:left-0 before:right-0 before:inline-block before:z-[1] before:border before:border-r-mode-accent before:border-b-mode-accent before:border-t-transparent before:border-l-transparent"
