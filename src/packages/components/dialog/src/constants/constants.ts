...
const DFEAULT_DIALOG_CONTENT_CLASSNAME =
	"_dialog-content relative z-50 grid w-[calc(100%_-_1rem)] sm:w-full sm:max-w-lg text-mode-contrast border border-mode-accent bg-background p-6 shadow-lg duration-medium data-[state=open]:animate-dialog-enter data-[state=closed]:animate-dialog-exit data-[state=closed]:fade-out-0 rounded-lg outline-none ring-ring-color ring-offset-background focus-visible:ring-ring-width focus-visible:ring-offset-offset"
