...
import { useEventListener } from "@renderui/hooks"
...
import {
  ...
  DEFAULT_DIALOG_CONTENT_CLASSNAME,
...
const DialogContent = (props: DialogContentProps) => {
  ...
  const { className: closeButtonIconClassName, ...restCloseButtonIconProps } =
    optional(closeButtonIconProps)

  const contentRef = useRef<HTMLDivElement | null>(null)
  const mergedRefCallback = useComposedRefs(ref, contentRef)
  ...
  return (
    <DialogPortalPrimitive {...portalProps}>
      <DialogOverlay {...overlayProps}>
        <DialogContentPrimitive
          data-slot="dialog-content"
          ref={mergedRefCallback}
          className={cn(DEFAULT_DIALOG_CONTENT_CLASSNAME, className)}
          style={{
